...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-ciphscoin create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Ciphscoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-ciphscoin setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-ciphscoin setconfig' to change your settings")
        return True
